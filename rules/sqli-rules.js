...
const sqliRules = [
  // ───────────────────────── Tautologies ─────────────────────────
  {
    ...
    pattern: /['"\s]\s*OR\s+1\s*=\s*1/i,
  },
  {
    id: 'SQLI-0002',
    severity: 'critical',
    description: "Tautology: OR 'a'='a' variant",
    pattern: /['"\s]\s*OR\s+['"][a-z]['"]\s*=\s*['"][a-z]['"]/i,
  },
  {
    id: 'SQLI-0003',
    severity: 'critical',
    description: 'Tautology: OR true / OR 1',
    pattern: /['"\s]\s*OR\s+(true|1)\b/i,
  },
  {
    id: 'SQLI-0004',
    severity: 'high',
    description: 'Tautology: numeric equality bypass (e.g. 1=1, 2=2)',
    pattern: /['"\s]\s*OR\s+\d+\s*=\s*\d+/i,
  },
  {
    id: 'SQLI-0005',
    severity: 'high',
    description: "Tautology: OR ''='' variant",
    pattern: /['"\s]\s*OR\s+['"]{2}\s*=\s*['"]{2}/i,
  },
  {
    id: 'SQLI-0006',
    severity: 'high',
    description: 'Tautology: AND 1=1 always-true probe',
    pattern: /['"\s]\s*AND\s+\d+\s*=\s*\d+/i,
  },
